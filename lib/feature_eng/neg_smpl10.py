...
class Seq(object):
    ...
    def __init__(self, dic4seq, row_dic, col_dic, row_csr, col_csr, 
        ...
        self.y = np.array([[y] * self.stack_size])
    ...
    def get_data(self, combs):
        ...
        y = self.get_ret_y()
        return (np.array([users_id]), neg_user, np.array([prods_id]), neg_prod, y)
