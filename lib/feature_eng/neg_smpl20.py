...
def make_model(num_user=20, num_product=10,
    ...
    '''user x neg_prod'''
    #embed_neg_user_a = Lambda(lambda x: K.expand_dims(x, axis=1))(embed_neg_user)
    prob4 = Lambda(calc_prob2, name='calc_prob4', arguments={'nn1': stack_size, 'nn2': num_neg})([embed_user, embed_neg_prod])
    #print('prob4 >', K.int_shape(prob4))
    model_prob4 = Model([input_user, input_neg_prod], prob4, name='model_prob4')
    
    prob4_cnfm = Lambda(calc_prob2, name='calc_prob4_cnfm', arguments={'nn1': stack_size, 'nn2': num_neg})([input_user_vec, input_neg_prod_vec])
    model_prob4_cnfm = Model([input_user_vec, input_neg_prod_vec], prob4_cnfm, name='model_prob4_cnfm')
