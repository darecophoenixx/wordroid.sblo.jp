...
'''
neg_smpl14 <- neg_smpl8
ネガティブサンプリングのロス関数を別にして重みを下げる
ネガティブサンプリングはフワッと離れてくれれば良い
'''
...
class Seq(object):
    ...
    def __init__(self, comb, row_dic, col_dic, csc, row_csr=None, col_csr=None, 
        ...
        self.row_indeces = set(range(csc.shape[0]))
        self.col_indeces = set(range(csc.shape[1]))
...
def make_model(num_user=20, num_product=10,
    ...
    #print('prob_neg >', K.int_shape(prob_neg))
